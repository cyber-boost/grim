# Grim.so Privacy Policy

**Effective Date: July 15, 2025**  
**Last Revised: July 15, 2025**

CyberBoost LLC ("Licensor," "we," "us," or "our"), a Florida limited liability company, is committed to safeguarding your privacy. This Privacy Policy ("Policy") outlines our practices concerning the collection, use, and disclosure of information through our Grim.so software, including all source code, object code, executable files, documentation, and related services (collectively, the "Software"), and any associated offerings.
...
### 1.05 You or Your
"You" or "Your" means an individual or Legal Entity (as defined in the Grim.so Software License Agreement) interacting with the Software or our services.
...
- To administer licenses, including verifying Small Entity or Commercial Use status as defined in the Grim.so Software License Agreement.
...
- To comply with legal obligations and enforce the Grim.so Software License Agreement.
...
While we strive to maintain robust security measures, no system can guarantee absolute security. To the maximum extent permitted by law, Licensor shall not be liable for unauthorized access or breaches beyond our reasonable control, as provided in the Grim.so Software License Agreement.

## Article VI - Data Retention

### 6.01 Retention Periods
Information will be retained only for as long as necessary to fulfill the purposes outlined in this Policy, or as required by applicable law, regulation, or the Grim.so Software License Agreement.
...
### 7.02 Deletion
You may request deletion of Your Personal Information, subject to legal retention obligations or legitimate business purposes, including those under the Grim.so Software License Agreement.
...
- **Legal Basis**: Processing is based on contractual necessity (e.g., Grim.so Software License Agreement), legitimate interests, legal obligations, or consent.
...
This Policy, together with the Grim.so Software License Agreement, constitutes the entire agreement between the parties with respect to the subject matter herein and supersedes all prior or contemporaneous agreements, understandings, or discussions, whether oral or written.
