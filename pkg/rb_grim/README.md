...
```bash
grim rb-setup                            # Setup Ruby environment
grim rb-analyze <path>                   # Analyze Ruby code quality
grim rb-test <path>                      # Run RSpec tests
grim rb-lint <path>                      # Ruby syntax checking
grim rb-deploy <path>                    # Deploy Ruby application
grim rb-monitor <path>                   # Monitor Ruby application
grim rb-rails <action>                   # Rails operations
grim rb-docker <action>                  # Docker Ruby operations
grim rb-k8s <action>                     # Kubernetes Ruby operations
```
...
# Compress
grim.compress('file.log', algorithm: 'zstd')
```
...
Rails.application.config.grim.backup(Rails.root)
...
- RubyGems: https://rubygems.org/gems/grim-reaper
