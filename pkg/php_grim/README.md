...
```bash
grim php-setup                           # Setup PHP environment
grim php-analyze                         # Static code analysis
grim php-secure                          # Security audit
grim php-optimize                        # Performance optimization
grim composer-backup                     # Backup Composer dependencies
grim laravel-backup                      # Laravel application backup
grim wordpress-backup                    # WordPress site backup
grim drupal-backup                       # Drupal site backup
```
...
// Monitor
$grim->monitor('/var/log/apache2');

// Compress
$grim->compress('large-file.sql', ['algorithm' => 'zstd']);
?>
```
...
- Packagist: https://packagist.org/packages/grim/reaper
